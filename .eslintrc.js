module.exports = {
    ...
    globals: {
        ...
        "innogyForm": true,
        "components": true,
        "innogyMultistepForm": true,
        "regionalizationEndpoints": true,
        "defaultHeaders": true,
        "stcUserData": true,
        "stcLoginData": true,
    ...
    rules: {
        ...
        'react/no-danger': 0, // to turn off the dangerouslySetInnerHTML warning
        'react/no-multi-comp': 0, // after cleaning will remove this
        'react/require-default-props': 0,
        'jsx-a11y/no-static-element-interactions': 0, // becuase custom select from SM is using div with onClick
        strict: 0
    },
};